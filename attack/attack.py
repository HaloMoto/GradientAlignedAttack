...
class Attack(object):
    ...
    def __init__(self, name, model):
        ...
        self._is_specified_target = False
    ...
    def set_mode_targeted_specify(self):
        r"""
        ...
        self._attack_mode = "targeted(specify)"
        self._targeted = True
        self._is_specified_target = True
        print("Attack mode is changed to 'targeted(specify).'")
